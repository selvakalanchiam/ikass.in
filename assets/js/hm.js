...
const SUPABASE_URL = "https://vyuttatyobyejlbmmhhz.supabase.co";
  ...
  // Embedded as base64 so it always renders instantly in print/PDF output —
  // no network fetch needed at print time, which was causing the logo to
  // go missing (the browser printed before the external image finished loading).
  const LOGO_DATA_URI = "data:image/png;base64,";
  ...
  async function invGenerateAndPrint(){
    ...
    document.getElementById('bmiPrintArea').innerHTML = '';
  ...
  // ============================================================
  // BMI / HEALTH REPORT — completely separate from billing.
  // Reference ranges: WHO (World Health Organization) BMI
  // classification; WHO/ISH blood pressure categories; WHO/IDF
  // (International Diabetes Federation) blood glucose ranges.
  // This is informational only — not a medical diagnosis.
  // ============================================================
  let bmiSelectedPatient = null;

  function classifyBMI(bmi){
    if (bmi < 18.5) return { label: 'Underweight', color: '#3b82f6' };
    if (bmi < 25)   return { label: 'Normal weight', color: 'var(--moss)' };
    if (bmi < 30)   return { label: 'Overweight', color: '#d99a3e' };
    return { label: 'Obese', color: 'var(--red)' };
  }

  function classifyBP(sys, dia){
    if (sys < 90 || dia < 60) return { label: 'Low', color: '#3b82f6' };
    if (sys < 120 && dia < 80) return { label: 'Normal', color: 'var(--moss)' };
    if (sys < 130 && dia < 80) return { label: 'Elevated', color: '#d99a3e' };
    if (sys < 140 || dia < 90) return { label: 'High — Stage 1', color: '#e0793a' };
    if (sys < 180 && dia < 120) return { label: 'High — Stage 2', color: 'var(--red)' };
    return { label: 'Hypertensive Crisis', color: '#8b0000' };
  }

  function classifySugar(value, type){
    const fastingLike = (type === 'Fasting');
    if (value < 70) return { label: 'Low', color: '#3b82f6' };
    if (fastingLike){
      if (value < 100) return { label: 'Normal', color: 'var(--moss)' };
      if (value < 126) return { label: 'Prediabetes range', color: '#d99a3e' };
      return { label: 'Diabetes range', color: 'var(--red)' };
    } else {
      if (value < 140) return { label: 'Normal', color: 'var(--moss)' };
      if (value < 200) return { label: 'Prediabetes range', color: '#d99a3e' };
      return { label: 'Diabetes range', color: 'var(--red)' };
    }
  }

  function bmiSetBadge(badgeId, cat){
    const el = document.getElementById(badgeId);
    el.textContent = cat.label;
    el.style.backgroundColor = cat.color;
  }

  function bmiRecalcAll(){
    const h = parseFloat(document.getElementById('bmiHeight').value);
    const w = parseFloat(document.getElementById('bmiWeight').value);
    if (h > 0 && w > 0){
      const bmi = w / ((h / 100) ** 2);
      const cat = classifyBMI(bmi);
      document.getElementById('bmiValueDisplay').textContent = bmi.toFixed(1);
      bmiSetBadge('bmiCategoryBadge', cat);
      document.getElementById('bmiResultRow').style.display = 'flex';
    } else {
      document.getElementById('bmiResultRow').style.display = 'none';
    }

    const sys = parseFloat(document.getElementById('bmiBpSystolic').value);
    const dia = parseFloat(document.getElementById('bmiBpDiastolic').value);
    if (sys > 0 && dia > 0){
      const cat = classifyBP(sys, dia);
      document.getElementById('bpValueDisplay').textContent = `${sys}/${dia} mmHg`;
      bmiSetBadge('bpCategoryBadge', cat);
      document.getElementById('bpResultRow').style.display = 'flex';
    } else {
      document.getElementById('bpResultRow').style.display = 'none';
    }

    const sugar = parseFloat(document.getElementById('bmiSugarValue').value);
    if (sugar > 0){
      const type = document.getElementById('bmiSugarType').value;
      const cat = classifySugar(sugar, type);
      document.getElementById('sugarValueDisplay').textContent = `${sugar} mg/dL (${type})`;
      bmiSetBadge('sugarCategoryBadge', cat);
      document.getElementById('sugarResultRow').style.display = 'flex';
    } else {
      document.getElementById('sugarResultRow').style.display = 'none';
    }
  }
  ['bmiHeight','bmiWeight','bmiBpSystolic','bmiBpDiastolic','bmiSugarValue','bmiSugarType'].forEach(id => {
    document.getElementById(id).addEventListener('input', bmiRecalcAll);
    document.getElementById(id).addEventListener('change', bmiRecalcAll);
  });

  // ---------- Patient search (reuses the same customer list as Invoice Generator) ----------
  function bmiFilterPatients(term){
    const resultsDiv = document.getElementById('bmiPatientResultsList');
    const lower = term.toLowerCase().trim();
    resultsDiv.innerHTML = '';
    resultsDiv.style.display = 'block';

    const list = lower === '' ? invAllCustomers : invAllCustomers.filter(c =>
      (c.name || '').toLowerCase().includes(lower) ||
      (c.patientId && String(c.patientId).toLowerCase().includes(lower)) ||
      (c.phone && String(c.phone).toLowerCase().includes(lower))
    );
    ...
    if (list.length === 0){
      resultsDiv.innerHTML = '<div class="inv-result-item" style="color:var(--red);">No matching patients found.</div>';
      return;
    }
    ...
    list.slice(0, 30).forEach(c => {
      const displayId = c.patientId || c.id;
      resultsDiv.innerHTML += `
        <div class="inv-result-item" onclick="bmiSelectPatient('${escapeHtml(c.id)}')">
          ${escapeHtml(c.name)} (ID: ${escapeHtml(displayId)}) — Ph: ${escapeHtml(c.phone || '—')}
        </div>`;
    });
  }
  document.getElementById('bmiPatientSearch').addEventListener('input', (e) => bmiFilterPatients(e.target.value));
  document.getElementById('bmiPatientSearch').addEventListener('focus', (e) => bmiFilterPatients(e.target.value));
  document.getElementById('bmiPatientSearch').addEventListener('blur', () => {
    setTimeout(() => { document.getElementById('bmiPatientResultsList').style.display = 'none'; }, 200);
  });

  function bmiSelectPatient(customerId){
    const c = invAllCustomers.find(x => x.id == customerId);
    if (!c) return;
    bmiSelectedPatient = c;
    document.getElementById('bmiPatientResultsList').style.display = 'none';
    document.getElementById('bmiPatientSearch').value = '';
    document.getElementById('bmiSelectedPatientDisplay').innerHTML = `
      <strong>Patient ID:</strong> ${escapeHtml(c.patientId || c.id)}<br>
      <strong>Name:</strong> ${escapeHtml(c.name)}<br>
      <strong>Age:</strong> ${escapeHtml(c.age || 'N/A')} &nbsp;&nbsp; <strong>Sex:</strong> ${escapeHtml(c.sex || 'N/A')}`;
    bmiLoadHistory();
  }

  async function bmiLoadHistory(){
    const listEl = document.getElementById('bmiHistoryList');
    if (!bmiSelectedPatient){ listEl.innerHTML = '<div class="empty">Select a patient to see their past reports.</div>'; return; }

    const { data } = await sb
      .from('health_reports')
      .select('*')
      .eq('customerId', String(bmiSelectedPatient.id))
      .order('timestamp', { ascending: false })
      .limit(5);

    if (!data || data.length === 0){
      listEl.innerHTML = '<div class="empty">No past reports for this patient yet.</div>';
      return;
    }
    ...
    listEl.innerHTML = data.map(r => `
      <div class="row">
        <div>
          <div class="row-date">${formatDMY(r.recordedDate)}</div>
          <div class="row-time">BMI ${r.bmi} (${r.bmiCategory}) &nbsp;·&nbsp; BP ${r.bpSystolic}/${r.bpDiastolic} &nbsp;·&nbsp; Sugar ${r.sugarValue} mg/dL</div>
        </div>
      </div>`).join('');
  }

  function bmiGenerateReportHTML(rec){
    const bmiCat = classifyBMI(rec.bmi);
    const bpCat = classifyBP(rec.bpSystolic, rec.bpDiastolic);
    const sugarCat = classifySugar(rec.sugarValue, rec.sugarType);

    const metricRow = (label, value, cat) => `
      <tr>
        <td style="padding:12px; border:1px solid #ccc; font-weight:bold;">${label}</td>
        <td style="padding:12px; border:1px solid #ccc;">${value}</td>
        <td style="padding:12px; border:1px solid #ccc;">
          <span style="display:inline-block; padding:4px 12px; border-radius:14px; color:#fff; font-size:0.85em; background:${cat.color};">${cat.label}</span>
        </td>
      </tr>`;
    ...
    return `
      <div style="max-width:700px; margin:0 auto; padding:20px; border:1px solid #ccc; color:#000; font-size:11pt;">
        ...
        <h2 style="text-align:center; margin:0 0 20px 0; letter-spacing:0.05em;">WELLNESS / BMI REFERENCE REPORT</h2>

        <div style="display:flex; justify-content:space-between; margin-bottom:20px;">
          <div style="flex:1;">
            <p style="margin:0;"><strong>PATIENT ID:</strong> ${escapeHtml(rec.patientId)}</p>
            <p style="margin:5px 0 0 0;"><strong>DATE:</strong> ${formatDMY(rec.recordedDate)}</p>
          </div>
          <div style="flex:1; text-align:right;">
            <p style="margin:0; font-weight:bold;">${escapeHtml(rec.customerName)}</p>
            <p style="margin:0; font-size:0.9em;">Age: ${escapeHtml(rec.age || 'N/A')} &nbsp;|&nbsp; Sex: ${escapeHtml(rec.sex || 'N/A')}</p>
          </div>
        </div>

        <table style="width:100%; border-collapse:collapse; margin-bottom:16px;">
          <thead><tr>
            <th style="padding:10px; border:1px solid #ccc; background:#f2f2f2; text-align:left;">Metric</th>
            <th style="padding:10px; border:1px solid #ccc; background:#f2f2f2; text-align:left;">Reading</th>
            <th style="padding:10px; border:1px solid #ccc; background:#f2f2f2; text-align:left;">Status</th>
          </tr></thead>
          <tbody>
            ${metricRow('BMI (Body Mass Index)', `${rec.bmi} kg/m² &nbsp; (Height ${rec.height} cm, Weight ${rec.weight} kg)`, bmiCat)}
            ${metricRow('Blood Pressure', `${rec.bpSystolic}/${rec.bpDiastolic} mmHg`, bpCat)}
            ${metricRow(`Blood Sugar (${escapeHtml(rec.sugarType)})`, `${rec.sugarValue} mg/dL`, sugarCat)}
          </tbody>
        </table>

        <div style="font-size:0.75em; color:#555; border-top:1px dashed #aaa; padding-top:12px; margin-top:10px;">
          <p style="margin:0 0 6px 0;"><strong>Reference standards:</strong> BMI classification per WHO (World Health Organization). Blood pressure categories per WHO/ISH (International Society of Hypertension) guidelines. Blood glucose ranges per WHO/IDF (International Diabetes Federation).</p>
          <p style="margin:0;"><em>This report is for general wellness reference only and does not constitute a medical diagnosis. Please consult a qualified physician for medical advice.</em></p>
        </div>

        <div style="border-top:1px dashed #aaa; margin-top:40px; padding-top:20px; text-align:right;">
          <p style="margin:0; padding-top:30px; color:#000;">Authorized Signature</p>
        </div>
      </div>`;
  }

  document.getElementById('bmiGeneratePrintBtn').addEventListener('click', async () => {
    const msgEl = document.getElementById('bmiMsg');
    if (!bmiSelectedPatient){ showMsg(msgEl, 'Select a patient first.', 'err'); return; }
    ...
    const dia = parseFloat(document.getElementById('bmiBpDiastolic').value);
    const sugar = parseFloat(document.getElementById('bmiSugarValue').value);
    const sugarType = document.getElementById('bmiSugarType').value;

    if (!(height > 0) || !(weight > 0) || !(sys > 0) || !(dia > 0) || !(sugar > 0)){
      showMsg(msgEl, 'Enter height, weight, blood pressure, and sugar before generating.', 'err');
      return;
    }
    ...
    const sugarCat = classifySugar(sugar, sugarType);

    const rec = {
      customerId: String(bmiSelectedPatient.id),
      patientId: bmiSelectedPatient.patientId || bmiSelectedPatient.id,
      customerName: bmiSelectedPatient.name,
      age: bmiSelectedPatient.age,
      sex: bmiSelectedPatient.sex,
      height, weight, bmi, bmiCategory: bmiCat.label,
      bpSystolic: sys, bpDiastolic: dia, bpCategory: bpCat.label,
      sugarValue: sugar, sugarType, sugarCategory: sugarCat.label,
      recordedDate: istDateStr(nowIST()),
      recordedBy: currentEmployee ? (currentEmployee.name || currentEmployee.username) : 'Unknown'
    };

    const { error } = await sb.from('health_reports').insert(rec);
    if (error){ showMsg(msgEl, 'Could not save report: ' + error.message, 'err'); return; }

    showMsg(msgEl, 'Report saved. Opening print preview…', 'ok');
    document.getElementById('invInvoicePrintArea').innerHTML = '';
    document.getElementById('bmiPrintArea').innerHTML = bmiGenerateReportHTML(rec);
    window.print();

    await bmiLoadHistory();
  });
...
// expose handlers referenced via inline onclick="..." in generated HTML
  window.bmiSelectPatient = bmiSelectPatient;
  window.invSelectCustomerFromList = invSelectCustomerFromList;
})();
